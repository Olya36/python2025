...
WAIT_FOR_DATE, WAIT_FOR_PLACE, WAIT_FOR_PERSON, WAIT_FOR_CHECK = range(4)
...
async def get_person(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
